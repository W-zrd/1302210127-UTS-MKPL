...
public class Employee {
    ...
    public int getAnnualIncomeTax() {
        ...
        MaritalStatus maritalStatus = spouseIdNumber == null ? MaritalStatus.SINGLE : MaritalStatus.MARRIED;
        return TaxFunction.calculateTax(monthlySalary, otherMonthlyIncome, monthWorkingInYear, annualDeductible, maritalStatus, childIdNumbers.size());
    }
}